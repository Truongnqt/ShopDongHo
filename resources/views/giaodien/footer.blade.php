         ...
         <div class="container">
          <div class="row">
            <div class="col-sm-4 s-left">
              <footer>
        <a href="index.php"><img src="public\image\icon\shopdongho.jpg" width="75px" height="50px" style="border: 1px solid black; margin-top: 20px; "></a>
